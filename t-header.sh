...
echo -e '\033[1;43;30m### EL PAYASO MAS TEMIDO DE TODA LA RED ### \033[0m';
echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-++-+-+-+-+-+-+\e[00m';
echo "";
echo -e "\e[1;34m┌─[\e[1;32m$PROC\e[1;33m@\e[36mgitaniko_klk69\e[1;34m]\e[0m-\e[1;34m[\e[33m$(date +'%d %a %b')\e[1;34m]\e[0m-\e[1;34m[\e[33m$(date +'%l:%M %p')\e[1;34m]
